...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'SubdataSelectionTester'):
...
impl_SubdataSelectionTester = SubdataSelectionTester(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'SubdataSelectionTester'
        ...
        self.rpc_service.add(impl_SubdataSelectionTester.get_object_subset,
                             name='SubdataSelectionTester.get_object_subset',
                             types=[list])
        self.method_authentication['SubdataSelectionTester.get_object_subset'] = 'required'
        self.rpc_service.add(impl_SubdataSelectionTester.hello_world,
                             name='SubdataSelectionTester.hello_world',
                             types=[basestring])
        self.method_authentication['SubdataSelectionTester.hello_world'] = 'required'
        self.rpc_service.add(impl_SubdataSelectionTester.status,
                             name='SubdataSelectionTester.status',
                             types=[dict])
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "SubdataSelectionTester but no authentication header was passed"
                            raise err
